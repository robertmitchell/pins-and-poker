...
public class ScrollShadow : MonoBehaviour, IBeginDragHandler
{
    [Header("Resources")]
    ...
    //{
    //    //StopCoroutine("LeftCGFadeOut"); StopCoroutine("LeftCGFadeIn");
    //    //StopCoroutine("RightCGFadeOut"); StopCoroutine("RightCGFadeIn");
    //    leftCG.alpha = 0f;
    //    rightCG.alpha = 0f;
