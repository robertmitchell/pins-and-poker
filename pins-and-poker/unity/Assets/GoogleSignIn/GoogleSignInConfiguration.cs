...
namespace Google {
  ...
  public class GoogleSignInConfiguration {
    ...
    /// </summary>
    /// <remarks>Note: The game configuration is not supported on non-Android
    /// platforms.
    ...
    /// <summary>Web client requestId associated with this app.</summary>
    /// <remarks>Required for requesting auth code or requestId token.</remarks>
    ...
    /// <summary>LeagueRequest email address, requires consent.</summary>
    public bool RequestEmail = false;
    /// <summary>LeagueRequest requestId token, requires consent.</summary>
    public bool RequestIdToken = false;
    /// <summary>LeagueRequest profile information, requires consent.</summary>
    ...
    /// <summary>Account usergueNameTxt to use when authenticating,
